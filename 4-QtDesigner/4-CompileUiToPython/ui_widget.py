...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.section_line_edit = QLineEdit(self.widget)
        self.section_line_edit.setObjectName(u"section_line_edit")

        self.horizontalLayout_2.addWidget(self.section_line_edit)
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_2.setText(QCoreApplication.translate("Widget", u"Section: ", None))
