...
class Widget(QWidget):
    ...
    def __init__(self):
        ...
        # def addWidget(row, column, rowSpan, columnSpan, [Qt::Alignment alignment = Qt::Alignment()])
        grid_layout.addWidget(button_1, 0, 0)
        grid_layout.addWidget(button_2, 0, 1, 1, 2)     # Take 1 row and 2 columns
        grid_layout.addWidget(button_3, 1, 0, 2, 1)     # Take 2 rows and 1 column
