...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/cut.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/about.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout.setIcon(icon6)
        self.actionAboutQt = QAction(MainWindow)
        self.actionAboutQt.setObjectName(u"actionAboutQt")
        icon7 = QIcon()
        icon7.addFile(u":/images/aboutQt.png", QSize(), QIcon.Normal, QIcon.Off)
